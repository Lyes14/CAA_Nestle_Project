...
In a Google Cloud project, go to BigQuery, then create a table by clicking on "Add". Here is an example: ![Creating Table in BigQuery](Images/Table.png)

Next, define the schema like this: ![Scheme](Images/Scheme.png)
